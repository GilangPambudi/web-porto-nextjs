**Gilang Pambudi Wibawanto S.Tr.S.I.B**
...
| **State Polytechnic of Malang** | Aug 2021 - Jul 2025 |
| ------------------------------- | ------------------- |

Applied Bachelor of Business Information Systems

Department of Information Technology, Cumulative GPA: 3.61/4.00

Relevant Coursework: Web Developer, IT Staff, Software Engineer

**WORK EXPERIENCE**

**Ngalam Folding Bike**

| WordPress Developer (Interns) | Oct 2024 - Des 2024 |
| ----------------------------- | ------------------- |
...
**PROJECT AND FREELANCE EXPERIENCE**

**SMADATARA Run 2026**

| Freelance Web Developer | Dec 2025 |
| ----------------------- | -------- |
...
**EMPEROR - Intelligent Employee Career Development System**

| Freelance Software Developer | Sep - Dec 2025 |
| ---------------------------- | -------------- |

- Developed the front-end of the system for PT Sari Bahari (via third-party vendor).
- Implemented existing UI components within a Laravel and Inertia.js front-end.

**Folding Ngalam Freedom for All**

| Freelance Web Developer | Aug 2025 |
| ----------------------- | -------- |
...
| Freelance Web Developer | May - Jun 2025 |
| ----------------------- | -------------- |
...
**Frontend:** HTML, CSS, JavaScript, Tailwind CSS, Bootstrap, Next.js, React.

**Backend:** PHP, Node.js.

**Database & Tools:** MySQL, Supabase, WordPress, Github, Laragon.

**Soft Skills:** Problem Solving, Teamwork, Communication, Adaptability.

**CERTIFICATION**

[Junior Web Developer by Badan Nasional Sertifikasi Profesi (BNSP)](https://drive.google.com/file/d/15eiZppecN9bE0Q5NUfyNxsKPKIaujYgo/view?usp=sharing)

[TOEIC](https://drive.google.com/file/d/11BVvQO_pewCSqIiyvweVcI0uAUY06k4A/view?usp=drive_link)
