...
export default function ContactSection() {
    ...
    return (
        <section ref={ref} id="contact" className="py-4 md:py-24 bg-white w-full flex items-center justify-center">
                ...
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 transition-all duration-1000 delay-300 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                    ...
                    <Card className="border-0 shadow-lg bg-white overflow-hidden">
                        ...
                        <CardContent className="p-8 space-y-6">
                            ...
                            <div className="flex items-start space-x-4">
                                <div className="bg-blue-50 p-3 rounded-full text-blue-700 shrink-0">
